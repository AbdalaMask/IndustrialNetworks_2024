...
public class OmronSerialDevice : Form
{
	...
	public OmronSerialDevice(Channel channel, Device? device = null)
	{
		InitializeComponent();
		try
		{
			...
			new Binding("Enabled", this.channel, "Protocol", formattingEnabled: true, DataSourceUpdateMode.OnPropertyChanged).Format += delegate(object? sender, ConvertEventArgs e)
			{
				if (e.Value != null)
				{
					...
					e.Value = ipsProtocolType == IpsProtocolType.HOSTLINK_FINS_PROTOCOL || ipsProtocolType == IpsProtocolType.HOSTLINK_CMODE_PROTOCOL;
				}
			};
	...
	private Group CreateSystemGroup(Device device)
	{
		...
		group.Tags.Add(new Tag
		{
			...
			Address = "SYS01",
			DataType = DataType.BYTE,
			Mode = TagMode.ReadWrite,
			ChannelId = device.ChannelId,
			DeviceId = device.Id,
			GroupId = group.Id,
			Description = "0: PROGRAM MODE, 2: MONITOR MODE, 4: RUN MODE."
		});
		return group;
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(NetStudio.IPS.OmronSerialDevice));
		...
		this.btnCancel.Location = new System.Drawing.Point(322, 305);
		this.btnCancel.Name = "btnCancel";
		this.btnCancel.Size = new System.Drawing.Size(76, 30);
		this.btnCancel.TabIndex = 8;
		this.btnCancel.Text = "Cancel";
		this.btnCancel.UseVisualStyleBackColor = true;
		this.btnSave.Location = new System.Drawing.Point(240, 305);
		...
		this.gbGeneral.Size = new System.Drawing.Size(389, 145);
		this.gbGeneral.TabIndex = 47;
		this.gbGeneral.TabStop = false;
		this.gbGeneral.Text = "General";
		this.txtConnectRetries.Location = new System.Drawing.Point(312, 85);
		...
		this.label6.Location = new System.Drawing.Point(213, 89);
		...
		this.txtDeviceName.Size = new System.Drawing.Size(272, 23);
		...
		this.chkAutoReconnect.Location = new System.Drawing.Point(213, 119);
		...
		this.txtChannel.Size = new System.Drawing.Size(272, 23);
		...
		this.txtStationNo.Location = new System.Drawing.Point(106, 85);
		...
		base.ClientSize = new System.Drawing.Size(408, 346);
