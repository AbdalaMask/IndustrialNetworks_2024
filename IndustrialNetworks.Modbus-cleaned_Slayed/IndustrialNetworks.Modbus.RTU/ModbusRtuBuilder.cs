...
public class ModbusRtuBuilder : ModbusBuilder
{
	public byte[] ReadMessage(byte stationNo, byte func, int address, int quantity)
	{
	...
	public byte[] WriteMessage(byte stationNo, byte func, int address, byte[] values)
	{
	...
	public byte[] WriteMessage(byte stationNo, byte func, int address, int quantity, byte[] values)
	{
